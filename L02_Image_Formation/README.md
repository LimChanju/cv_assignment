...
* **배경 지식:**
  ...
  - `cv2.getRotationMatrix2D()`: 2×3 변환 행렬 M을 반환하며, 수식은 $M = \begin{bmatrix} \alpha \cos\theta & -\alpha \sin\theta & t_x \\ \alpha \sin\theta & \alpha \cos\theta & t_y \end{bmatrix}$ (α: 스케일, θ: 회전 각도, $t_x, t_y$: 평행이동)
